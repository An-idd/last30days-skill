...
| Douyin (抖音) | `TIKHUB_API_KEY` | Douyin short videos + top comments (auto-enabled when key present) | pay-as-you-go (~$0.001/request) |
...
# Chinese sources
TIKHUB_API_KEY=<your-tikhub-key>          # enables Douyin (抖音); Bilibili is keyless
