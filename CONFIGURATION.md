...
| Douyin (抖音) | `TIKHUB_API_KEY` | Douyin short videos + top comments (auto-enabled; shares the Bilibili key) | pay-as-you-go (~$0.001/request) |
...
# Chinese sources
TIKHUB_API_KEY=<your-tikhub-key>          # enables Bilibili (B站) + Douyin (抖音)
